...
def setup_root(manage: bool=False):
    ...
    cl = tkinter.Button(root, text="入力クリア", font=font, command=clear_text)
    ...
    cl.pack(side=tkinter.LEFT)
    exit.pack(side=tkinter.LEFT)

    #register global vars
    modules["title"] = tb
    modules["text_name"] = txt
    modules["ok_button"] = ok
    modules["clear_button"] = cl
    modules["exit_button"] = exit
